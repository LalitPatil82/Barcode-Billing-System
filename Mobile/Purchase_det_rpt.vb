...
Public Class Purchase_det_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project.Purchase_det_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurchase_det_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Purchase_det_rpt = New Purchase_det_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
