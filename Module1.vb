Module Module1
    ...
    Public pr As Product
    Public Property flag As Integer
    Public Pname As String = ""
    Public c_year As Integer
    Public qty_det_tbl As Integer = 1
    Public qty As Integer = 0
    Public tot_qty As Integer = 0
    ...
    Public Quanty As Integer = 0
    Public P_rate As Integer = 0
    Public P_cgst As Integer = 0
    Public P_sgst As Integer = 0
    Public P_taxamt As Integer = 0
    Public P_words As String = ""
    Public Tax_amt As Integer = 0
